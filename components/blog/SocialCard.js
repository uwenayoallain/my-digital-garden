...
export default function SocialCard({ props }) {
    ...
    return (
        <>
            <motion.div className="relative my-1 mx-auto w-full md:w-5/6 lg:w-3/5 rounded z-10 grid grid-cols-5" {...props} initial="hidden" animate="visible" variants={container} whileHover="hover">
