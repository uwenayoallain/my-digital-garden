...
export default function SocialCard({ props }) {
    ...
    return (
        <>
            <motion.div className="relative my-5 mx-auto w-full md:w-11/12 lg:w-10/12 rounded z-10 grid grid-cols-5" {...props} initial="hidden" animate="visible" variants={container} whileHover="hover">
                <motion.a variants={variant1} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10"  >
                ...
                <motion.a variants={variant2} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10" >
                ...
                <motion.a variants={variant3} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10" >
                ...
                <motion.a variants={variant4} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10" >
                ...
                <motion.a variants={variant5} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10" >
                ...
                <motion.a variants={variant6} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10" >
                ...
                <motion.a variants={variant7} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10" >
                ...
                <motion.a variants={variant8} whileTap="tap" whileHover="hover" intial="hidden" animate="visible" href="https://www.github.com/uwenayoallain" className="m-2 flex p-6 justify-center items-center  bg-white/10 dark:bg-gray-800/10 rounded z-10" >
                ...
                <motion.div className="absolute inset-0 bg-gradient-to-br from-yellow-500 via-yellow-700 to-purple-800 z-0 rounded-full"></motion.div>
            </motion.div>
        </>
    )
}
