    ...
    <>
      <motion.div
        ...
        <motion.a
          ...
          className='z-10 flex items-center justify-center p-6 m-2 rounded bg-white/10 dark:bg-gray-800/10'>
          <svg
        ...
        <motion.a
          ...
          <svg
            ...
            <path d='M12.746 14.068v-2.636h.832v3.511H6.065v-3.511h.832v2.636z'></path>
            <path d='M7.816 11.182l4.087.898.173-.864-4.087-.898-.173.864zm.54-2.046l3.785 1.853.345-.796L8.703 8.33l-.346.806zm1.05-1.954l3.21 2.807.53-.67-3.21-2.808-.53.67zm2.075-2.08l-.67.523 2.486 3.523.67-.523-2.486-3.523zm-3.751 8.08h4.173v-.875H7.73v.875z'></path>
          </svg>
        </motion.a>
        <motion.a
          variants={variant5}
          ...
          <svg
            ...
            preserveAspectRatio='xMinYMin'
            className='icon__icon'>
            <path d='M0 0h20v6.857H10V8H5.556V6.857H0V0zm1.111 5.714h2.222V2.286h1.111v3.428h1.112V1.143H1.11v4.571zm5.556-4.571v5.714h2.222V5.714h2.222V1.143H6.667zm5.555 0v4.571h2.222V2.286h1.112v3.428h1.11V2.286h1.112v3.428h1.11V1.143h-6.666z'></path>
            <path d='M10 4.7H9V2.2h1z'></path>
          </svg>
        </motion.a>
        <motion.a
          variants={variant1}
        ...
        <motion.a
          ...
          <svg
            ...
            preserveAspectRatio='xMinYMin'
            className='icon__icon'>
            <path d='M3.683 16.418C1.436 14.722 0 12.14 0 9.248 0 4.14 4.477 0 10 0s10 4.14 10 9.248c0 5.107-4.477 9.248-10 9.248a10.77 10.77 0 0 1-2.96-.412l-3.357 1.891v-3.557zm5.25-9.703l-5.394 5.66 4.908-2.67 2.565 2.67 5.362-5.66-4.853 2.622-2.589-2.622z'></path>
          </svg>
        </motion.a>
        <motion.div className='absolute inset-0 z-0 rounded-full bg-gradient-to-br from-yellow-500 via-yellow-700 to-purple-800'></motion.div>
      </motion.div>
    </>
  );
}
