        ...
        <div className="h-screen leading-10 font-medium capitalize relative">
            <div className="grid grid-cols-4 pt-[10%] p-6 w-11/12 mx-auto">
                <div className="text-lg leading-10">
                    ...
                    <Image src={myImage} className="rounded-full" draggable="false" />
                </div>
                ...
                <div className="mt-2  h-full col-span-1">
                    ...
                    <p className="dark:text-gray-300 text-gray-700 text-sm">Stay up to date with the latest news and updates</p>
                    <Form>
                        <FormInput
                            type="text"
                            label="Your Name"
                ...
                <div className="ml-4 mt-2  h-full col-span-1">
                    ...
                    <a href="https://www.github.com/uwenayoallain" className="m-2 w-max inline-flex p-6 justify-center items-center  bg-gray-200 hover:bg-gray-300 dark:hover:bg-gray-700 dark:bg-gray-800 rounded-full"  >
                    ...
                    <a href="https://www.twitter.com" className="m-2 w-max inline-flex p-6 justify-center items-center  bg-gray-200 hover:bg-gray-300 dark:hover:bg-gray-700 dark:bg-gray-800 rounded-full" >
                    ...
                    <a href="mailto:uwenayoallain@gmail.com" className="m-2 w-max inline-flex p-6 justify-center items-center bg-gray-200 hover:bg-gray-300 dark:hover:bg-gray-700 dark:bg-gray-800 rounded-full" >
            ...
            <p className="absolute bottom-0 w-full text-center">All right reserved - uwenayoallain</p>
        </div>
    );
}
